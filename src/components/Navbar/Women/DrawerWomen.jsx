...
import { Box, Divider, Typography, Drawer, Button, IconButton } from '@mui/material';
...
const DrawerWomen = ({ open, onClose }) => {
  ...
  return (
    <Drawer anchor="left" open={open} onClose={onClose}>
      <Box sx={{ width: 300, display: 'flex', flexDirection: 'column', height: '100%',padding:2, }}>
