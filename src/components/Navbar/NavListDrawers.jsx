...
import { Box, Divider, List, ListItem, ListItemButton, ListItemIcon, Typography, Drawer, IconButton } from '@mui/material';
  ...
  return (
    <Box sx={{ width: 259 }}>
      <nav>
        ...
        <DrawerMan
          open={drawerOpen === 'Hombre'}
          onClose={handleDrawerClose}
        />
        <List>
          <ListItem disablePadding onClick={() => setLanzamientosOpen(true)} button>
        ...
        <Lanzamientos open={lanzamientosOpen} onClose={() => setLanzamientosOpen(false)} />
