...
const imgPath =
  "https://nikeclprod.vtexassets.com/assets/vtex/assets-builder/nikeclprod.store/3.0.10/icons/Assets_for_off%20platform/swoosh___33f7ffaf2fc124733c2c4a60a12a1160.svg";
  ...
  return (
    <ThemeProvider theme={theme}>
      <>
                  ...
                  sx={{
                    ...
                    ...(item &&
                      (item.title === "Cerrar sesión" ||
                        item.title === "Registrarse/Login" ||
                        item.title === "Centro de Ayuda | ") && {
        ...
        <FirstAppBar
          position="fixed"
          sx={{ top: "42px", boxShadow: "0 2px 4px rgba(12, 12, 255, 0.12)" }}
        >
          <Toolbar>
            <IconButton
              color="inherit"
            ...
            >
              {rightNavLinks.map((item, index) => (
                <Box
                  ...
                  sx={{
                    marginRight:
                      index === rightNavLinks.length - 1 ? "0" : "0.5rem",
                  }}
                >
                  <IconButton color="inherit" component="a" href={item.path}>
                    {item.icon}
                  </IconButton>
                </Box>
              ))}
            </Box>
            {windowWidth > 600 ? <CartDrawers /> : <CartDrawersMax />}
            {isAuthenticated &&
              (windowWidth > 600 ? <LoginDrawers /> : <LoginDrawerMax />)}
          </Toolbar>
        </FirstAppBar>
