  ...
  const handleDeleteAccount = async () => {
    try {
      const response = await axios.delete(
        "https://e-commerce-nestjs.onrender.com/api/user/delete-me",
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
    ...
    >
      ...
      >
        ...
        <Typography sx={detalles}>
          ¿Seguro que quieres eliminar tu cuenta? Parrella No podrás acceder más
          a la información de tu cuenta, como tu historial de pedidos, tu lista
          de deseos o tu progreso deportivo.
        </Typography>
