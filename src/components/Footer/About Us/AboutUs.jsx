        ...
        >
          ...
          >
            <Typography sx={{ flex: "1", maxWidth: "50%", padding: "0 20px" }}>
              <span style={{ fontWeight: "600" }}>PARRELLA</span> es una empresa
              dedicada a la venta de ropa con la mayor calidad en telas.
              <br />
              <br />
              Esta se destaca por su profesionalismo y responsabilidad para
              garantizar al cliente un excelente y satisfactorio resultado en
              cada uno de nuestros productos.
              <br />
              <br />
              Nuestra misión se basa en diseñar, producir y vender una gran
              variedad de prendas para vestir.
              <br />
              <br />
              Fomentando el apoyo y unión que nos caracteriza, contamos con una
              amplia variedad en diseños, colores y modelos innovadores.
              <br />
              <br />
              También logramos contar con la capacidad para ofrecerles un
              catálogo de ventas al mayor.
              <br />
              <br />
              Gracias a esto podemos incrementar el valor de la empresa y
              proporcionar estabilidad laboral a nuestros trabajadores.
              <br />
              <br />
            </Typography>
            <Box
        ...
        >
          ...
          >
            <Typography sx={{ padding: "0 20px" }}>
              ...
              <br /> <br />
              Nuestra misión se basa en diseñar, producir y vender una gran
              variedad de prendas para vestir. Fomentando el apoyo y unión que
              nos caracteriza, contamos con una amplia variedad en diseños,
              colores y modelos innovadores.
              <br /> <br />
              También logramos contar con la capacidad para ofrecerles un
              catálogo de ventas al mayor.
              <br /> <br />
