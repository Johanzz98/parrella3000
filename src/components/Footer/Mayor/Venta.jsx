      ...
      <Hidden mdDown>
        <Grid item xs={12} sm={5.5}>
          <Box sx={{ position: "relative", width: "100%", height: "100%" }}>
            <CardContent sx={{ p: 0 }}>
              <img
                src="https://demayoreo.com/cdn/shop/files/banners_con_informativo_1_785x.jpg?v=1671046723"
                loading="lazy"
                alt="Image 1"
                style={{
                  display: "block",
        ...
        <Grid item xs={12} sm={5.5}>
          <Box sx={{ position: "relative", width: "100%", height: "100%" }}>
            <CardContent sx={{ p: 0 }}>
              <img
                src="https://demayoreo.com/cdn/shop/files/banners_con_informativo_2_785x.jpg?v=1671056555"
                loading="lazy"
                alt="Image 2"
                style={{
                  display: "block",
