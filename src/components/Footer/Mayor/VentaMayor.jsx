...
const handleWhatsAppClick = () => {
  ...
  window.open(
    "https://api.whatsapp.com/send/?phone=56937552580&text&type=phone_number&app_absent=0",
    "_blank",
  );
};
const VentaMayor = () => {
  ...
  return (
    ...
    >
      ...
      >
        Empieza a elevar tus ventas, de manera rápida, sencilla y segura, en
        Parrella puedes encontrar una amplia lista de productos de alta calidad
        para comercializar tu mismo.
      </Typography>
      <Box
        sx={{
          padding: "0 7.5px",
