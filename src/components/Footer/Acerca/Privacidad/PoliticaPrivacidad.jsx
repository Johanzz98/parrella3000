...
>
    ...
    Compromiso de privacidad de Tommy Hilfiger
    </Typography>
    <Box>
        <Typography sx={{ 
    fontSize: "14px",
    ...
    Queremos que tenga la información que necesita para tomar decisiones significativas sobre su información personal. Por lo tanto, nos comprometemos a explicar en nuestros avisos de privacidad por qué recopilamos su información personal y cómo se utiliza esa información. Nos esforzaremos para que nuestros avisos de privacidad sean fáciles de encontrar, acceder y comprender.
...
Nos esforzamos continuamente por reconocer áreas en las que tenemos margen de mejora, perfeccionar nuestros procesos y actuar como líder en prácticas de datos y privacidad en nuestra industria.
    ...
    <Box>
    <Typography sx={detalles}>
    La responsabilidad de esta política de cookies reside en Tommy Hilfiger. Puedes contactar con nosotros en la dirección indicada más abajo.
    </Typography>
    </Box><Box>
        <Typography sx={{ 
    fontSize: "14px",
...
Puedes optar por no dar tu consentimiento a nuestro uso de estas “cookies de publicidad y redes sociales”.
  ...
  Nuestros datos de contacto
    ...
    <Typography sx={detalles}>
    Assa Chile SA
Avenida Del Valle Sur 577, comuna de Huechuraba
Dirección de correo electrónico: tommychile@aswgr.com
Teléfonos: +56 226660254
    </Typography>
    </Box>
    <Box>
        <Typography sx={{ 
