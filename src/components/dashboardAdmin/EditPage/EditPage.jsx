      ...
      <Box>
        ...
        {isEditing ? (
          ...
          <Typography sx={{ ...detalles, width: "86%" }}>
            ...
            essential to add to your footwear collection. These sneakers will
            take you straight back to the 80s...
          </Typography>
        )}
      </Box>
              ...
              >
                <Paper sx={getPaperStyle(size)}>
                  ...
                  <Typography
                    sx={{
                      fontSize: "14px",
                      color: isSizeSelected(size) ? "white" : "#111",
                      display: "flex",
      ...
      >
        ...
        >
          <Box>
            ...
            <Typography sx={detalles}>
              Envios gratís a partir de 75.000$
            </Typography>
          </Box>
        </Box>
          ...
          <Box sx={{ display: "grid", gridTemplateColumns: "1fr", gap: "8px" }}>
            ...
            >
              ...
              {isEditing ? (
                ...
                <Typography sx={detalles}>
                  These Nike shoes give a sporty and masculine look...
                </Typography>
              )}
            </Box>
            ...
            >
              ...
              {isEditing ? (
                ...
                <Typography sx={detalles}>
                  Ajuste holgado Cierre frontal y cuello alto...
                </Typography>
              )}
            </Box>
            ...
            >
              ...
              {isEditing ? (
                ...
                <Typography sx={detalles}>
                  INSTRUCCIONES DE LAVADO No usar blanqueador...
                </Typography>
              )}
            </Box>
          </Box>
