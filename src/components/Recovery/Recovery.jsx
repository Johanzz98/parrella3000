...
import { Box, Paper, Typography, TextField, Button, useMediaQuery, Modal } from '@mui/material';
...
<Box
          ...
          <Box sx={{ marginTop:'-64px', maxWidth: '800px', padding: '20px', borderRadius:'24px', textAlign: 'center', zIndex:1 }}>
  ...
  fontFamily: "Helvetica, sans-serif",
  fontOpticalSizing: 'auto',}}>
        Por favor introduce tu dirección de correo electrónico para recibir un email con las instrucciones para restablecer tu contraseña.
      </Typography>
