...
fontOpticalSizing: 'auto',}}>Credit Card</Typography>
        <Box sx={{ borderBottom: '2px solid black', marginBottom: '20px' }} />
      </Box>
...
>
  ...
  alignItems: 'center',
  fontFamily: "Helvetica,sans-serif",
  fontOpticalSizing: 'auto'}}>EXP.DATE</Typography>
                    </Box>
                  <Field
                as={TextField}
                fullWidth
  ...
  alignItems: 'center',
  fontFamily: "Helvetica,sans-serif",
  fontOpticalSizing: 'auto',marginBottom:'112px',}}>CVV</Typography>
  <Field
                as={TextField}
                fullWidth
                name="confirmPassword"
