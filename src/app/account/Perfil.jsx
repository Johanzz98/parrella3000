...
const Perfil = () => {
  ...
  return (
    <Box sx={{ backgroundColor: "white", width: "82%" }}>
      <Box sx={cuadros}>
        <Typography sx={helloName}>Resumen de cuenta</Typography>
      </Box>
      <Box
        sx={{
          ...cuadrosRellenos,
      ...
      >
        <Typography
          sx={{ ...detalles, color: isHoveredDireccion ? "white" : "black" }}
        >
          DIRECCIONES
        </Typography>
        <IconButton style={{ marginLeft: "auto" }}>
      ...
      >
        <Typography
          sx={{ ...detalles, color: isHoveredPreferencias ? "white" : "black" }}
        >
          PREFERENCIAS
        </Typography>
        <IconButton style={{ marginLeft: "auto" }}>
